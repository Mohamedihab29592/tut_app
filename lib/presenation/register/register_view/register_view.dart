                      ...
                      builder: (context, snapshot) {
                        return TextFormField(
                          ...
                          decoration: InputDecoration(
                              hintText: AppStrings.userNameInvalid.tr(),
                              labelText: AppStrings.userNameInvalid.tr(),
                  ...
                  child: StreamBuilder<String?>(
                      ...
                      builder: (context, snapshot) {
                        return TextFormField(
                          ...
                          decoration: InputDecoration(
                              hintText: AppStrings.passwordInvalid.tr(),
                              labelText: AppStrings.passwordInvalid.tr(),
                              errorText: snapshot.data),
                        );
                      }),
                ),
